 ...
 */
export function autodetectOS(url: string, signal: AbortSignal) {
    ...
    const channel = python.spawn(autoDetectOSScript, [url], { environ: ['GIO_USE_VFS=gvfs', 'LC_ALL=C.UTF-8'], err: 'message' });
    signal.onabort = () => channel.close();
    return channel;
}
