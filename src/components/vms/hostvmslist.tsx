...
import { Progress, ProgressVariant, ProgressMeasureLocation } from "@patternfly/react-core/dist/esm/components/Progress";
...
const VmUsageCpu = ({ vm } : {vm: VM | UIVM, }) => {
    ...
    return (
        <Progress value={cpuUsage}
            ...
            aria-label={_("CPU")}
            className="pf-m-bg ct-hide-progress-icon"
            min={0} max={100}
