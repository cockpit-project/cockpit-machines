...
/* This is an experiment re React state management patterns.
   ...
   Thus, if things get only slightly complicates I'll immediately make
   ...
   - When a state object should be disposed off, it's "close" method
     is called.  This method should close all channels etc.
