...
import {
    useSerialState, SerialActive, SerialActiveActions, SerialInactive, SerialMissing, SerialPending
} from './serial';
import { useVncState, VncActive, VncActiveActions, VncInactive, VncMissing, VncPending } from './vnc';
