...
export class SerialActive extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (newSpawnArgs.length !== oldSpawnArgs.length || oldSpawnArgs.some((arg, index) => arg !== newSpawnArgs[index]) || prevProps.state.connected != this.props.state.connected)
            this.updateChannel(this.props.spawnArgs);
    }
