...
export const SET_VIRT_INSTALL_CAPABILITIES = "SET_VIRT_INSTALL_CAPABILITIES";
export const SET_VIRT_XML_CAPABILITIES = "SET_VIRT_XML_CAPABILITIES";
...
export const ADD_UI_NOTIFICATION = "ADD_UI_NOTIFICATION";
